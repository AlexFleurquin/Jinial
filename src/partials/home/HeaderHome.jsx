          ...
          <div className="mr-4 flex justify-start">
            ...
            <nav className="inline">
              ...
              <ul className="flex justify-start flex-wrap items-center">
                <li>
                  <Link
                    className="font-medium text-gray-600 hover:text-gray-600 dark:hover:text-gray-100 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out"
                    to="/signin"
                  >
                    Pourquoi Jinial ?
                  </Link>
          ...
          <nav className="flex justify-between">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li className="ml-3">
                ...
                >
                  Commencer{' '}
                  <span className="tracking-normal font-inter text-gray-200 dark:text-gray-900 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">
                    -&gt;
                  </span>
                </Link>
              </li>

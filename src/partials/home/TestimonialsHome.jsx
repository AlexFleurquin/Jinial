      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          >
            {/* 1st Testimonial */}
            <article
              className="h-full flex flex-col p-6 bg-transparent rounded-lg border dark:border-slate-800 shadow-lg"
              data-aos="fade"
            ...
            >
              ...
              <footer className="text-sm text-gray-400">
                <span className="text-gray-300">Mark Luiss</span> -{' '}
                <a
            ...
            >
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">
                  Neon has made a huge impact on compliance, while helping us
                  become more transparent.
                </p>
              </div>
              <footer className="text-sm text-gray-400">
                <span className="text-gray-300">Patrick Mills</span> -{' '}
                <a
                  className="font-medium text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out"
                  href="#0"
                >
            ...
            >
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">
                  GitHub provides tools that are, in a sense, invisible. You
                  don’t have to waste time trying to get them to work.
                </p>
              </div>
              <footer className="text-sm text-gray-400">
                <span className="text-gray-300">David Collison</span> -{' '}
                <a
                  className="font-medium text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out"
                  href="#0"
                >
            ...
            >
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">
                  Neon is the tool devs. The more you can make work feel native
                  for a developer, the more cool their experience.
                </p>
              </div>
              <footer className="text-sm text-gray-400">
                <span className="text-gray-300">Licia McFarland</span> -{' '}
                <a
                  className="font-medium text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out"
                  href="#0"
                >
            ...
            >
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">
                  Neon comes into play during the entire software life cycle.
                  It’s the de facto tool for anything related to our software.
                </p>
              </div>
              <footer className="text-sm text-gray-400">
                <span className="text-gray-300">Rossana Alecu</span> -{' '}
                <a
                  className="font-medium text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out"
                  href="#0"
                >
            ...
            >
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">
                  I have no tech skills and with Neon I can actually make good
                  looking apps with ease.
                </p>
              </div>
              <footer className="text-sm text-gray-400">
                <span className="text-gray-300">Max Corsano</span> -{' '}
                <a
                  className="font-medium text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out"
                  href="#0"
                >
            ...
            >
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">
                  It's not just easier to get in touch with developers, it’s
                  also easier to bring in other team members.
                </p>
              </div>
              <footer className="text-sm text-gray-400">
                <span className="text-gray-300">Anna Pratt</span> -{' '}
                <a
                  className="font-medium text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out"
                  href="#0"
                >
            ...
            >
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">
                  Tools like Neon Advanced Security help keep our team lean. It
                  makes us much more efficient.
                </p>
              </div>
              <footer className="text-sm text-gray-400">
                <span className="text-gray-300">Veerle Larson</span> -{' '}
                <a
                  className="font-medium text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out"
                  href="#0"
                >
            ...
            >
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">
                  Neon enables speed and scale. We can work on bigger projects
                  and finish them faster.
                </p>
              </div>
              <footer className="text-sm text-gray-400">
                <span className="text-gray-300">Ana Kennedy</span> -{' '}
                <a
                  className="font-medium text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out"
                  href="#0"
                >
